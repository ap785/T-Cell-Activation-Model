...
def model_no_costim_TNF(x, t, params):
...
def model_with_cd2_TNF(x, t, params):
...
def model_with_icam_TNF(x, t, params):
...
def model_with_cd28_TNF(x, t, params):
...
def model_with_cd27_TNF(x, t, params):
...
def model_with_41bb_TNF(x, t, params):
...
params_no_costim_s_TNF = (0.0001, 1, 1e-2, 1, 0.1, 0.5, 0.2, 0.022)

                    #kon, koff, ksyn, kbasal, kdown, kact, kdeg, kcdeg, kon_2, koff_2, kcd2a, kcd2b kdown_2, kbasal_2, ksyn_2
params_with_cd2_s_TNF = (0.0001, 1, 1e-2, 1, 0.1, 0.5, 0.2, 0.022, 0.005, 1, 15 * 3600, 0.04 * 3600, 0.1, 1, 0.02)

params_with_icam_s_TNF = (0.0001, 1, 1e-2, 1, 0.1, 0.5, 0.2, 0.022, 0.001, 1, 0.5 * 3600, 0.001 * 3600, 0.1, 1, 0.02)
                     
#k28 value lower than kcd2 / kbb
params_with_cd28_s_TNF = (0.0001, 1, 1e-2, 1, 0.1, 0.5, 0.2, 0.0001, 0.001, 1, 0.1 * 3600, 0.1, 1, 0.02)

params_with_cd27_s_TNF = (0.0001, 1, 1e-2, 1, 0.1, 0.5, 0.2, 0.022, 0.001, 1, 0.001, 1, 0.02, 0.001 * 3600 * 3600)


# kon, koff, ksyn, kbasal, kdown, kact, kdeg, kcdeg,
params_with_41bb_s_TNF = (0.0001, 1, 1e-2, 1, 0.1, 0.5, 0.2, 0.022, 0.001, 1, 0.0001, 0.0001, 100, 9 * 3600 * 3600, 0.001 * 3600 * 3600)

params_no_costim = [param / 3600 for param in params_no_costim_s_TNF]
params_with_cd2 = [param / 3600 for param in params_with_cd2_s_TNF]
params_with_icam = [param / 3600 for param in params_with_icam_s_TNF]
params_with_cd28 = [param / 3600 for param in params_with_cd28_s_TNF]
params_with_cd27 = [param / 3600 for param in params_with_cd27_s_TNF]
params_with_41bb = [param / 3600 for param in params_with_41bb_s_TNF]

# Solve ODEs for both models
x_no_costim_TNF = odeint(model_no_costim_TNF, x0_no_costim, t, args=(params_no_costim,))
x_with_cd2_TNF = odeint(model_with_cd2_TNF, x0_with_cd2, t, args=(params_with_cd2,))
x_with_icam_TNF = odeint(model_with_icam_TNF, x0_with_icam, t, args=(params_with_icam,))
x_with_cd28_TNF = odeint(model_with_cd28_TNF, x0_with_cd28, t, args=(params_with_cd28,))
x_with_cd27_TNF = odeint(model_with_cd27_TNF, x0_with_cd27, t, args=(params_with_cd27,))
x_with_41bb_TNF = odeint(model_with_41bb_TNF, x0_with_41bb, t, args=(params_with_41bb,))
